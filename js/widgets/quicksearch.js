var app_cardealer_widget_quicksearch = null;
jQuery(document).ready(function() {
	app_cardealer_widget_quicksearch = new THEMEMAKERS_APP_CARDEALER_WIDGET_QUICKSEARCH();
	...
	var self = {
        ...
        clear_select: function(select) {
			select.each(function(){
                jQuery(this).val(0).html('<option value="0">' + lang_any + '</option>');
            });
		}
	};
