...
/*! theme.js */
!function(e,t,i){"use strict";e.fn.life=function(t,i,n){return e(this.context).on(t,this.selector,i,n),this},e(function(){if(e(".breadcrumbs").length){e(".breadcrumbs .menu").prepend('<a href="/">'+lang_home+"</a>");var n=e(".breadcrumbs").find("a").last();e(n).replaceWith(e(n).text())}e(".main").prepend('<div id="info_popup-wrapper"><ul id="info_popup-wrapper-page"><li><div class="info_popup"></div></li></ul></div>'),e(".js_option_checkbox").life("click",function(){e(this).val(e(this).is(":checked")?1:0)}),e(".fb-comments").length&&!function(e,t,i){var n,a=e.getElementsByTagName(t)[0];e.getElementById(i)||(n=e.createElement(t),n.id=i,n.src="//connect.facebook.net/en_EN/all.js#xfbml=1",a.parentNode.insertBefore(n,a))}(i,"script","facebook-jssdk");var a=!1;e(".form-account #loginform").life("submit",function(t){if(a!==!0){var i=e(".form-account #user_login").val(),n=e(".form-account #user_pass").val(),o=e(this);if(""!==i&&""!==n){t.preventDefault();var s={action:"app_cardealer_login_check",login:i,pass:n};e.post(ajaxurl,s,function(t){"1"===t?(a=!0,o.trigger("submit")):"-1"===t?(e(".form-account #user_login").trigger("focus"),show_info_popup(lang_failed_login_l)):"-2"===t&&(e(".form-account #user_pass").trigger("focus"),show_info_popup(lang_failed_login_p))})}return a=!1,!1}}),function(){var i={down:"downarrowclass",right:"rightarrowclass"},n=e("#navigation").find("ul").eq(0),a=n.find("ul").parent();a.each(function(){var t=e(this);this.istopheader=1===t.parents("ul").length?!0:!1,t.children("a").append('<span class="'+(this.istopheader?i.down:i.right)+'"></span>')}),n.on("mouseenter","li",function(){var t=e(this),i=t.children("ul");i.length&&t.addClass("hover"),i.hide().stop(!0,!0).fadeIn(200)}).on("mouseleave","li",function(){e(this).removeClass("hover").children("ul").stop(!0,!0).fadeOut(50)}),e(".nav-responsive").on("click",function(t){t.preventDefault(),e(this).hasClass("active")?e(this).removeClass("active"):e(this).addClass("active")}),e(".nav-responsive").on("change",function(){t.location=e(this).val()})}(),function(){if(e(".layout-switcher").length){var t=e(".layout-switcher a");t.on("click",function(){var t=e(this),i=t.data("css-class"),n=e("#change-items");return t.siblings("a").removeClass("active").end().addClass("active"),n.removeClass("item-grid item-list").addClass(i),e.cookie("cars_listing_layout_class",i,{expires:365,path:"/"}),!1})}}(),function(){if(e(".acc-box").length){var t=e(".acc-box");t.each(function(t,i){var n=e(".acc-trigger",e(i));n.on("click",function(){var t=e(this);return"toggle"===t.data("mode")?t.toggleClass("active").next().stop(!0,!0).slideToggle(300):t.next().is(":hidden")?(n.removeClass("active").next().slideUp(300),t.toggleClass("active").next().slideDown(300)):t.hasClass("active")&&t.removeClass("active").next().slideUp(300),!1})})}}(),function(){e(".content-tabs").length&&e(".content-tabs").tabs()}(),function(){if(e(".widget-title").length||e(".section-title").length||e(".comment-reply-title").length){var t=e(".widget-title, .section-title, .comment-reply-title");t.each(function(t,i){var n,a,o="",s=e(i);s.hasClass("comment-reply-title")?(o=s.contents().filter(function(){return this.nodeType==Node.TEXT_NODE}).text(),n=o.split(" "),a=n.shift(),s.html(function(e,t){return"<span>"+a+" </span>"+t.split(" ").slice(1).join(" ")})):(o=s.text(),o=e.trim(o),n=o.split(" "),a=n.shift(),s.html("<span>"+a+" </span>"+n.join(" ")))})}}(),function(){e("select").length&&e("select").not(".nav-responsive").each(function(){var t=e(this);t.parent(".sel").length||t.wrap('<div class="sel" />'),t.parent(".sel")&&t.attr("disabled")&&t.parent(".sel").addClass("disabled")})}(),function(){e.fn.placeholder()}(),function(){var i={button:"#back-top",backToTop:".divider-top a",text:"Back to Top",min:200,fadeIn:400,fadeOut:400,speed:800,easing:"easeOutQuint"};e("body").append('<a href="#" id="'+i.button.substring(1)+'" title="'+i.text+'">'+i.text+"</a>"),e(t).scroll(function(){var n=e(t).scrollTop();n>i.min?e(i.button).fadeIn(i.fadeIn):e(i.button).fadeOut(i.fadeOut)}),e(i.button).add(i.backToTop).click(function(t){e("html, body").animate({scrollTop:0},i.speed,i.easing),t.preventDefault()})}(),function(){if(e(".image-post-slider > ul").length){var i=e(".image-post-slider > ul");e(t).load(function(){i.each(function(t){var i=e(this);i.children("li").length<2||i.css("height",i.children("li:first").height()).after('<div class="post-slider-nav"><a class="prevBtn post-nav-prev-'+t+'">Prev</a><a class="nextBtn post-nav-next-'+t+'">Next</a> </div>').cycle({containerResize:!0,easing:"easeInOutExpo",fx:"fixedScrollHorz",fit:!0,next:".post-nav-next-"+t,pause:!0,prev:".post-nav-prev-"+t,slideResize:!0,speed:600,timeout:5e3}).data("slideCount",i.children("li").length)}),e(".post-slider-nav a").on("mouseenter",function(){e(this).parent().prev().cycle("pause")}).on("mouseleave",function(){e(this).parent().prev().cycle("resume")}),i.data("slideCount")<=1&&i.next(".post-slider-nav").hide(),e(t).on("resize",function(){i.css("height",i.find("li:visible img").height())}),Modernizr.touch&&i.swipe({swipeLeft:swipeFunc,swipeRight:swipeFunc,allowPageScroll:"auto"})})}}(),e.fn.extend({fitVids:function(t){var n={customSelector:null};if(!i.getElementById("fit-vids-style")){var a=i.createElement("div"),o=i.getElementsByTagName("base")[0]||i.getElementsByTagName("script")[0],s="&shy;<style>.fluid-width-video-wrapper{width:100%;position:relative;padding:0;}.fluid-width-video-wrapper iframe,.fluid-width-video-wrapper object,.fluid-width-video-wrapper embed {position:absolute;top:0;left:0;width:100%;height:100%;}</style>";a.className="fit-vids-style",a.id="fit-vids-style",a.style.display="none",a.innerHTML=s,o.parentNode.insertBefore(a,o)}return t&&e.extend(n,t),this.each(function(){var t=["iframe[src*='player.vimeo.com']","iframe[src*='youtube.com']","iframe[src*='youtube-nocookie.com']","iframe[src*='kickstarter.com'][src*='video.html']","object","embed"];n.customSelector&&t.push(n.customSelector);var i=e(this).find(t.join(","));i=i.not("object object"),i.each(function(){var t=e(this);if(!("embed"===this.tagName.toLowerCase()&&t.parent("object").length||t.parent(".fluid-width-video-wrapper").length)&&-1===t.attr("width").indexOf("%")&&-1===t.attr("height").indexOf("%")){var i="object"===this.tagName.toLowerCase()||t.attr("height")&&!isNaN(parseInt(t.attr("height"),10))?parseInt(t.attr("height"),10):t.height(),n=isNaN(parseInt(t.attr("width"),10))?t.width():parseInt(t.attr("width"),10),a=i/n;if(!t.attr("id")){var o="fitvid"+Math.floor(999999*Math.random());t.attr("id",o)}t.wrap('<div class="fluid-width-video-wrapper"></div>').parent(".fluid-width-video-wrapper").css("padding-top",100*a+"%"),t.removeAttr("height").removeAttr("width").show()}})})}}),e(".container").fitVids(),function(){if(e.fn.cycle.transitions.fixedScrollHorz=function(t,i,n){t.css("overflow","hidden"),n.before.push(e.fn.cycle.commonReset);var a=t.width();n.animIn.left=0,n.animOut.left=0-a,n.cssFirst.left=0,n.cssBefore.left=a,n.cssBefore.top=0,"prev"===t.data("dir")&&(n.cssBefore.left=-a,n.animOut.left=a)},e(".image-post-slider-cars-listing > ul").length){var i=e(".image-post-slider-cars-listing > ul");e(t).load(function(){e("#change-items .image-post").each(function(){e(this).height(e(this).find("a").find("img").height())}),e(t).resize(function(){e("#change-items .image-post").each(function(){e(this).height(e(this).find("a").find("img").height())})}),i.each(function(){var i=e(this);if(!(i.children("li").length<2)){i.css("height",i.children("li:first").height()).cycle({before:function(){var t=e(this);t.parent().stop().animate({height:t.height()},300)},containerResize:!1,easing:"easeInOutExpo",fx:"fixedScrollHorz",fit:1,resume:!0,pause:!0,slideResize:!0,speed:500,timeout:200,width:"fit"}).data("slideCount",i.children("li").length),i.cycle("pause"),i.data("slideCount")>1&&e(t).on("resize",function(){i.css("height",i.find("li").height())});var n=!1;i.hover(function(){if(1!=n){var t=e(this);if(t.children("li").length<2)return;t.cycle("resume"),n=!0}}),i.mouseleave(function(){n=!1;var t=e(this);t.children("li").length<2||t.cycle("pause")}),Modernizr.touch&&i.swipe({swipeLeft:swipeFunc,swipeRight:swipeFunc,allowPageScroll:"auto"})}})})}}(),e.fn.cycle.transitions.fixedScrollHorz=function(t,i,n){e(".post-slider-nav a").on("click",function(e){t.data("dir",""),e.target.className.indexOf("prev")>-1&&t.data("dir","prev")}),t.css("overflow","hidden"),n.before.push(e.fn.cycle.commonReset);var a=t.width();n.animIn.left=0,n.animOut.left=0-a,n.cssFirst.left=0,n.cssBefore.left=a,n.cssBefore.top=0,"prev"===t.data("dir")&&(n.cssBefore.left=-a,n.animOut.left=a)},function(){e(".single-image.fancybox").length&&e(".single-image.fancybox").fancybox({titleShow:!0,padding:"10",transitionIn:"fade",transitionOut:"fade",easingIn:"easeOutBack",easingOut:"easeInBack",helpers:{title:{type:"over"}}}),e("a.video-image-youtube").length&&e("a.video-image-youtube").on("click",function(){var t="";return t=-1!==this.href.indexOf("watch?v=")?this.href.replace(new RegExp("watch\\?v=","i"),"v/")+"&autoplay=1":this.href.replace(new RegExp("youtu.be/","i"),"www.youtube.com/v/")+"&autoplay=1",e.fancybox({titleShow:!1,transitionIn:"elastic",transitionOut:"elastic",href:t,type:"swf",swf:{wmode:"transparent",allowfullscreen:"true"},centerOnScroll:!0,speedIn:100,speedOut:50,width:640,height:480}),!1}),e("a.video-image-vimeo").length&&e("a.video-image-vimeo").on("click",function(){return e.fancybox({type:"iframe",href:this.href.replace(new RegExp("vimeo.com","i"),"player.vimeo.com/video")+"?title=0&byline=0&portrait=0&color=f6e200",overlayShow:!0,centerOnScroll:!0,speedIn:100,speedOut:50,width:640,height:480}),!1})}(),function(){if(e(".col-scroll").length&&e(t).width()>767){var i=0;e(".data-feature").each(function(t,n){e(n).find("li").each(function(t,n){var a=e(n).height();a>i&&(i=a)})}),e(".data-feature").find("li").height(i),e(".col-scroll").carouFredSel({responsive:!0,auto:!1,prev:"#carou_prev",next:"#carou_next",width:"100%",scroll:2,items:{width:190,visible:{min:3,max:4}}}).on("click",".js_remove_car_from_compare_list",function(){return e(this).parents(".col").animate({opacity:0},500).animate({width:0,margin:0,borderWidth:0},500,function(){e(".col-scroll").trigger("removeItem",e(this))}),!1})}}()}),e.fn.placeholder=function(){"undefined"==typeof i.createElement("input").placeholder&&e("[placeholder]").focus(function(){var t=e(this);t.val()===t.attr("placeholder")&&(t.val(""),t.removeClass("placeholder"))}).blur(function(){var t=e(this);(""===t.val()||t.val()===t.attr("placeholder"))&&(t.addClass("placeholder"),t.val(t.attr("placeholder")))}).blur().parents("form").submit(function(){e(this).find("[placeholder]").each(function(){var t=e(this);t.val()===t.attr("placeholder")&&t.val("")})})},e.fn.tabs=function(){var t=e(this);t.each(function(t,i){var n=e(".tabs-nav",e(i)),a=n.children("li"),o=e(".tab-content",e(i));a.first().addClass("active").show(),o.first().show(),n.on("click","li",function(t){var i=e(this),n=i.index();i.siblings("li").removeClass("active").end().addClass("active"),o.hide().eq(n).fadeIn(300),t.preventDefault()})})},function(e){e.fn.extend({actual:function(t,i){var n,a,o,s,r,l,c,d;if(!this[t])throw'$.actual => The jQuery method "'+t+'" you called does not exist';return o=e.extend({absolute:!1,clone:!1,includeMargin:void 0},i),a=this,o.clone===!0?(c=function(){a=a.filter(":first").clone().css({position:"absolute",top:-1e3}).appendTo("body")},d=function(){a.remove()}):(c=function(){n=a.parents().andSelf().filter(":hidden"),s=o.absolute===!0?{position:"absolute",visibility:"hidden",display:"block"}:{visibility:"hidden",display:"block"},r=[],n.each(function(){var e,t={};for(e in s)t[e]=this.style[e],this.style[e]=s[e];r.push(t)})},d=function(){n.each(function(e){var t,i=r[e];for(t in s)this.style[t]=i[t]})}),c(),l=/(outer)/g.test(t)?a[t](o.includeMargin):a[t](),d(),l}})}(jQuery)}(jQuery,window,document);
